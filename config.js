module.exports = {
	...
	'facebookAuth' : {
        ...
        'callbackURL'   : 'https://murmuring-mesa-82755.herokuapp.com/api/auth/facebook/callback'
    },
     'googleAuth': {
        'clientID': '855194110354-kcvenm6kprjpb9qpqntmvsf7njvhho73.apps.googleusercontent.com',
        'clientSecret': 'uvIDcroIgmxy2MEFH4W-WJCx',
        'callbackURL': 'https://murmuring-mesa-82755.herokuapp.com/api/auth/google/callback'
    }
}
